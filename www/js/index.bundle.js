...
var Preloader = function () {
   ...
   */
  function Preloader() {
    var $preloader = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : $('#preloader');
  ...
  _createClass(Preloader, [{
    ...
    value: function runAnimation() {
      ...
      return new Promise(function (resolve) {
        // hide shadow
        _this2.$preloader.addClass(_this2.noShadowsClass);

        // animate preloader's lines
        _animation2.default.tweenWithTimeout(_this2.$leftLines, 1, {
          time: 1.3,
          params: { css: { x: '-100%' } }
        }).tweenWithTimeout(_this2.$rightLines, 1, {
          time: 1.3,
          params: {
            css: { x: '100%' },
            onComplete: resolve
    ...
    value: function init() {
      ...
      return new Promise(function (resolve) {
        _this.runAnimation().then(resolve);
      });
    }
  }]);
...
var Animation = function () {
  ...
  _createClass(Animation, null, [{
     ...
     * @returns {Boolean}
     */
    value: function checkForErrors(target) {
    ...
    key: 'setTween',
    value: function setTween(target, settings) {
    ...
    key: 'delay',
    value: function delay(timeout, func) {
    ...
    key: 'staggerDelay',
    value: function staggerDelay($items, stagger, func, timeout) {
      if (!$items) {
      ...
      this.delay(timeout, function () {
        $items.each(function (index, element) {
          Animation.delay(timeOut, function () {
            return func.call(null, element, index);
          });
          timeOut += stagger;
        });
      });
    ...
    key: 'tweenWithTimeout',
    value: function tweenWithTimeout(target, timeout, settings) {
      var method = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'to';
    ...
    key: 'steppedAnimation',
    value: function steppedAnimation(params) {
      var firstStep = params.one;
      var firstStepIsFunc = typeof firstStep === 'function';
      ...
      var emptyStep = function emptyStep(resolve) {
        return resolve();
      };
      ...
      // first step
      .then(function () {
        return new Promise(params.one ? params.one : emptyStep);
      })

      // second step
      .then(function () {
        return new Promise(params.two ? params.two : emptyStep);
      })

      // third step
      .then(function () {
        return new Promise(params.three ? params.three : emptyStep);
      })

      // fourth step
      .then(function () {
        return new Promise(params.four ? params.four : emptyStep);
      })

      // fifth step
      .then(function () {
        return new Promise(params.five ? params.five : emptyStep);
      });
    }
  }]);
